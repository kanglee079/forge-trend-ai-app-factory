PLUGINS = [
    ...
    {"id": "app_archetypes", "name": "App Archetypes", "type": "app_archetype", "enabled": True, "capabilities": ["education", "productivity", "utility", "habit_tracker", "checklist", "content_tool", "finance_basic"], "config_schema": {}},
